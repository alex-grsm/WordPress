                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<? the_field('instagram'); ?>" class="footer__social-item">
                            ...
                            <a href="<? the_field('facebook'); ?>" class="footer__social-item">
                            ...
                            <a href="<? the_field('youtube'); ?>" class="footer__social-item">
